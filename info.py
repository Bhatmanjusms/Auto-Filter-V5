...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/filmyfunda_tv')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/serials_funda')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/serials_funda_bot')
MSG_ALRT = environ.get('MSG_ALRT', 'Share and Support Us')

# Custom Chats
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', -1001724974823))
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', -1001831635652))
FILE_CHANNEL_LINK = environ.get('FILE_CHANNEL_LINK', 't.me/serials_daily')
HOW_DWLD_LINK = environ.get('HOW_DWLD_LINK', 'https://t.me/serials_daily/20')

# Log Channels
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1001896983424))
RQST_LOG_CHANNEL = int(environ.get('RQST_LOG_CHANNEL', -1001896983424))
...
URL_SHORTNER_WEBSITE_API = environ.get('URL_SHORTNER_WEBSITE_API', '0e63f62be230b425d61891b13d03b227353e1946')
